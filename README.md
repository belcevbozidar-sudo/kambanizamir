...
Сайт на фондация в обществена полза „Камбани за мир" и инициативата
„Камбанен звън огласява мира" (21 септември 2026 г.).
...
kambanizamir/
├── index.html                    Начало
├── za-iniciativata.html          За инициативата
...
├── manifesti.html                Манифести (пълен текст)
├── materiali.html                Материали за изтегляне
├── partnori.html                 Партньори и подкрепа
├── sponsorski-paketi.html        Партньорски пакети
...
Header и footer са еднакви на всичките 11 страници — ако искате да промените
